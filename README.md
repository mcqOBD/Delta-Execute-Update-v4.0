...
[![Stars](https://img.shields.io/github/stars/Delta-Execute-Update-v4.0?style=flat-square)](https://github.com)
...
git clone https://github.com/Delta-Execute-Update-v4.0.git
cd Delta-Execute-Update-v4.0
